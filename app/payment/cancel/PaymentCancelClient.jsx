...
export default function PaymentCancelClient() {
  ...
  const openApp = useCallback(() => {
    ...
    if (typeof window !== 'undefined' && window.dataLayer) {
      window.dataLayer.push({ event: 'payment_cancel_deeplink' });
    }
  ...
  return (
    <>
      <NavBar />
      <section className="status-section" id="payment-cancel">
        <div className="container">
          <div className="status-card glass">
            ...
            <p className="text-body">
              Your payment was cancelled. We&apos;re redirecting you back to the app
